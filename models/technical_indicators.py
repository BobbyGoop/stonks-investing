...
if __name__ == "__main__":
	...
	for stock in stocks:
		country = 'russia'
		technical_indicators = investpy.technical_indicators(stock, 'russia', 'stock', interval='daily')
		moving_averages = investpy.moving_averages(stock, country, 'stock', interval='daily')
